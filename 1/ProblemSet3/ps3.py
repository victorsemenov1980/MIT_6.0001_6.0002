...
def is_valid_word(word, hand, word_list):
    ...
    for letter in word:
        if letter in new_hand:
            new_hand[letter]-=1
            if new_hand[letter]<0 or word not in word_list:
                boolean+=[0]
                # if boolean.count(0)>=1:
                #     # return False
                #     print('false')
                # else:
                #     # return True
    ...
    if boolean.count(0)>=1 or letter not in hand:
        return False
       # print('false')
    else:
        return True
...
def calculate_handlen(hand):
    ...
    # print(hand_length)
    # print(len(hand_length))
    length=len(hand_length)
    return length
    pass  # TO DO... Remove this line when you implement this function
...
if __name__ == '__main__':
    ...
    play_game(word_list)
n=HAND_SIZE
# n=int(input('Please input number for letters in first hand '))
hand=deal_hand(n)
print('')
